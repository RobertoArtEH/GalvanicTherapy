...
<center><a href="pdfs/Productosmasvendidos.php" target="_blank"><button class="btn btn-danger"> Reporte <i class="fas fa-file-pdf fa-lg"style="color:white"></i></button></a></center>
  </div>
</div>
</div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#demo">Consultar</button>
  ...
  <label for="">Hasta</label>
    ...
    <center>
<button class="btn btn-danger"> Reporte <i class="fas fa-file-pdf fa-lg"style="color:white"></i>
</button></center>
</form>    
  </div>
  </div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#demo2">Consultar</button>
